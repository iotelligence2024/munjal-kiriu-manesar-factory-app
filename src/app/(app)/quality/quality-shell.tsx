...
type QualityRouteCard = {
	title: string;
	href: string;
};

type QualityShellProps = {
	activeHref?: string;
	children?: React.ReactNode;
};

const qualityCards: QualityRouteCard[] = [
	{
		title: "DIGITAL CHECKSHEET",
		href: "/quality/digital-checksheet",
	},
];

export function QualityShell({ activeHref, children }: QualityShellProps) {
	return (
